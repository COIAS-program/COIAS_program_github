...
#hdulist.info()
#edit 2019.11.7
#scidata = hdu1[0].data +50
#edit 2020.5.5
scidata = hdu1[0].data + 250
wcs1 = WCS(hdu1[0].header).celestial
#nan => 0
...
### conver to png by zscale ############
zlist = zscale(scidata)
scidata1 = np.where(scidata>zlist[1], zlist[1], scidata) 
scidata2 = np.where(scidata<zlist[0], zlist[0], scidata1) 
plt.imsave("test.png",scidata2,cmap=plt.cm.gray,origin="lower")
