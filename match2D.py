...
#file_list
    ...
    for i in range(len(data1)):
        ...
        for j in range(len(data2)):
            if data1[i,1] -0.000001 < data2[j,0] and data1[i,1] + 0.000001 > data2[j,0] and data1[i,2] - 0.0005 < data2[j,1] and  data1[i,2] + 0.0005 > data2[j,1] and data1[i,3] - 0.0005 < data2[j,2] and  data1[i,3] + 0.0005 > data2[j,2]:
