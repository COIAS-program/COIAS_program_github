...
#mag xy pixel
                ...
                temp2 = [name[i],t8,rah2,ram2,decd3,decm2,decs3,mag2,filobs,fil[i,1],data[i,3],data[i,4],data[i,5],data[i,6]]
...
#negligible under 100
        ...
        np.savetxt('numbered_mpc.txt',result1,fmt="%s")
        np.savetxt('numbered_all.txt',result2,fmt="%s")
        np.savetxt('numbered_disp.txt',result3,fmt="%s")
